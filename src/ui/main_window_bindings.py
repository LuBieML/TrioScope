...
PLOT_METHODS = ['_create_scope_plot', '_on_plot_double_click', '_recreate_subplots', '_configure_plot', '_configure_fft_plot', '_on_manual_range_change', '_reposition_stats_texts', '_flush_stats_reposition', '_update_curve_detail', '_flush_curve_detail', '_do_update_curve_detail', '_on_xy_manual_zoom', '_add_hover_elements_to_plot', '_on_main_plot_mouse_moved', '_flush_hover_update', '_open_trace_window', '_open_compare', '_on_compare_closed', '_push_compare_data', '_compute_fft_payload_for_trace', '_reset_fft_state', '_toggle_cursors', '_init_cursor_positions', '_add_cursors_to_plots', '_remove_cursors_from_plots', '_on_cursor_line_moved', '_toggle_y_cursors', '_y_trace_entries', '_default_y_cursor_positions', '_init_y_cursor_positions', '_add_y_cursors_to_plots', '_remove_y_cursors_from_plots', '_on_y_cursor_line_moved', '_get_nearest_index', '_update_cursor_readout', '_setup_3d_view', '_build_3d_colorbar', '_update_colorbar_range', '_update_x_links', '_on_lock_x_changed', '_on_plot_mode_changed', '_on_path_view_scale_changed', '_sync_path_view_scale', '_update_path_info_label', 'add_trace', 'on_trace_changed', '_on_pin_toggled', 'get_enabled_traces', '_render_plots', 'toggle_auto_scroll', '_update_auto_scroll_button', '_fit_all_data', 'clear_data', '_apply_plot_settings']
